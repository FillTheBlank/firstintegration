$(function(){
    ...
    $('input#index').inputfocus({ value: field_values['index'] });
    $('input#street').inputfocus({ value: field_values['street'] }); 
    $('input#house').inputfocus({ value: field_values['house'] }); 
    $('input#flat').inputfocus({ value: field_values['flat'] }); 
